...
<div id="page">
    ...
    <div class="content_body">
        ...
        <div class="case_main">
            <div class="content_title title_style">案例展示</div>
            <div class="case_content">
              ...
              <tbody><tr>
                ...
                <td align="left" style="padding-bottom:10px;"><div style="width:200px; margin:0 4px;">
                    <div class="p_img"><a href="caseDetail.php?photo=show_2013韦德中国行广州球迷见面会.png" title="2013韦德中国行广州球迷见面会"><img src="uploadfile/show_2013韦德中国行广州球迷见面会.png" width="200" height="140" border="0"></a></div>
                    <div class="p_font" style="text-align:center;"><a href="caseDetail.php?photo=show_2013韦德中国行广州球迷见面会.png" title="2013韦德中国行广州球迷见面会">2013韦德中国行广州球迷见面会</a></div>
                  </div></td>
                
                <td align="left" style="padding-bottom:10px;"><div style="width:200px; margin:0 4px;">
                    <div class="p_img"><a href="caseDetail.php?photo=show_gladith新装发布.png" title="gladith新装发布"><img src="uploadfile/show_gladith新装发布.png" width="200" height="140" border="0"></a></div>
                    <div class="p_font" style="text-align:center;"><a href="caseDetail.php?photo=show_gladith新装发布.png" title="gladith新装发布D">gladith新装发布</a></div>
                  </div></td>
                
                <td align="left" style="padding-bottom:10px;"><div style="width:200px; margin:0 4px;">
                    <div class="p_img"><a href="caseDetail.php?photo=show_澳门雅培年.png" title="澳门雅培年"><img src="uploadfile/show_澳门雅培年会.png" width="200" height="140" border="0"></a></div>
                    <div class="p_font" style="text-align:center;"><a href="caseDetail.php?photo=show_澳门雅培年.png" title="澳门雅培年">澳门雅培年</a></div>
                  </div></td>
                
                
              </tr>
              
              <tr><td align="left" style="padding-bottom:10px;"><div style="width:200px; margin:0 4px;">
                    <div class="p_img"><a href="caseDetail.php?photo=show_百威张敬轩歌友会.png" title="百威张敬轩歌友会"><img src="uploadfile/show_百威张敬轩歌友会.png" width="200" height="140" border="0"></a></div>
                    <div class="p_font" style="text-align:center;"><a href="caseDetail.php?photo=show_百威张敬轩歌友会.png" title="百威张敬轩歌友会">百威张敬轩歌友会</a></div>
                  </div></td>
                
                <td align="left" style="padding-bottom:10px;"><div style="width:200px; margin:0 4px;">
                    <div class="p_img"><a href="caseDetail.php?photo=show_广东省食品药品检验所50周年.png" title="广东省食品药品检验所50周年"><img src="uploadfile/show_广东省食品药品检验所50周年.png" width="200" height="140" border="0"></a></div>
                    <div class="p_font" style="text-align:center;"><a href="caseDetail.php?photo=show_广东省食品药品检验所50周年.png" title="广东省食品药品检验所50周年">广东省食品药品检验所50周年</a></div>
                  </div></td>
                
                <td align="left" style="padding-bottom:10px;"><div style="width:200px; margin:0 4px;">
                    <div class="p_img"><a href="caseDetail.php?photo=show_大益茶年会.png" title="大益茶年会"><img src="uploadfile/show_大益茶年会.png" width="200" height="140" border="0"></a></div>
                    <div class="p_font" style="text-align:center;"><a href="caseDetail.php?photo=show_大益茶年会.png" title="大益茶年会">大益茶年会</a></div>
                  </div></td>
			...
			<tr><td align="left" style="padding-bottom:10px;"><div style="width:200px; margin:0 4px;">
                    <div class="p_img"><a href="caseDetail.php?photo=show_芬腾内衣15周年庆典.png" title="芬腾内衣15周年庆典"><img src="uploadfile/show_芬腾内衣15周年庆典.png" width="200" height="140" border="0"></a></div>
                    <div class="p_font" style="text-align:center;"><a href="caseDetail.php?photo=show_芬腾内衣15周年庆典.png" title="芬腾内衣15周年庆典">芬腾内衣15周年庆典</a></div>
                  </div></td>
                
                <td align="left" style="padding-bottom:10px;"><div style="width:200px; margin:0 4px;">
                    <div class="p_img"><a href="caseDetail.php?photo=show_广铝集团中秋晚会.png" title="广铝集团中秋晚会"><img src="uploadfile/show_广铝集团中秋晚会.png" width="200" height="140" border="0"></a></div>
                    <div class="p_font" style="text-align:center;"><a href="caseDetail.php?photo=show_广铝集团中秋晚会.png" title="广铝集团中秋晚会">广铝集团中秋晚会</a></div>
                  </div></td>
                
                <td align="left" style="padding-bottom:10px;"><div style="width:200px; margin:0 4px;">
                    <div class="p_img"><a href="caseDetail.php?photo=show_花都皇冠酒店金域检验.png" title="花都皇冠酒店金域检验"><img src="uploadfile/show_花都皇冠酒店金域检验.png" width="200" height="140" border="0"></a></div>
                    <div class="p_font" style="text-align:center;"><a href="caseDetail.php?photo=show_花都皇冠酒店金域检验.png" title="花都皇冠酒店金域检验">花都皇冠酒店金域检验</a></div>
                  </div></td>
                ...
                <div><form method="get" onsubmit="document.location = '#';return false;">[首页] [上一页] [<a href="#">下一页</a>] [<a href="#">尾页</a>][页次:<font color="red">1</font>/7] [共78条 <font color="red">12</font>条/页] 转到<input name="page" size="4" value="1">页<input type="submit" value="go"></form></div>
            </div>
        </div>
        <div class="clear"></div>
    </div>
