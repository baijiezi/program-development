...
<div id="page">
    ...
    <div id="main">
        <div class="main_box">
            <div id="about_us">
                <div class="aboutus_title"><a href="about.php" class="title_more"><img src="images/more.gif" /></a></div>
            ...
            <div id="news">
                <div class="news_title"><a href="news.php" class="title_more"><img src="images/more.gif" /></a></div>
                <div id="first_news">
                    <img src="images/news_img.jpg" />
                    <div class="first_news_body">
                        <a href="news.php">五月天520佛山歌友演唱会</a>
                        展会概述：随着LED照明技术的创新与发展，成本的不断下降，LED市场潜力将得到迅...
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="other_news">
                    <ul>
                        <li>- 琶洲国际会展中心广州车展<span>2013-01-01</span></li>
                        <li>- 贵州电视台媒体推介会<span>2013-01-01</span></li>
                    </ul>
                </div>
            </div>

            <div id="contact">
                <div class="contact_title"><a href="contectUs.php" class="title_more"><img src="images/more.gif" /></a></div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td style="text-align:left;">http://baijiezi.github.io/juguang/</td>
  </tr>
  <tr>
    ...
    <td style="text-align:left;">jgled88@qq.com</td>
        ...
        <div id="show">
            <div class="show_title"><a href="cases.php" class="title_more"><img src="images/more.gif" /></a></div>
                ...
                <div id="demo">
                    <div id="indemo">
                        <div id="demo1" class="show_body">
                            ...
                            <img src="uploadfile/show_gladith新装发布.png" />
                            <img src="uploadfile/show_澳门雅培年会.png" />
                            <img src="uploadfile/show_百威张敬轩歌友会.png" />
                            <img src="uploadfile/show_广铝集团中秋晚会.png" />
                            <img src="uploadfile/show_芬腾内衣15周年庆典.png"/>
