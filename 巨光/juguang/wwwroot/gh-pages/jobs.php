...
<div id="page">
    ...
    <div id="main"> 
        <div class="index_left left">
            <div class="left_title"><h4>&nbsp;&nbsp;&nbsp;&nbsp;招聘信息</h4></div>    
        	<div class="left_list"  >-&nbsp;&nbsp;<a href="jobs.php" title="业务经理">业务经理</a></div>
            <div class="left_list"  >-&nbsp;&nbsp;<a href="jobs_1.php" title="客服经理">客服经理</a></div>
            <div class="left_list"  >-&nbsp;&nbsp;<a href="jobs_2.php" title="LED应用工程师">LED应用工程师</a></div>
        </div>
        
        <div class="rbg left">
        	<div class="right_title">&nbsp;&nbsp;&nbsp;&nbsp;招聘职务</div>
            

            <div class="right_bg" style="text-align:left;">
	   	  		<p><font face="宋体">公司由于业务拓展，现招聘技术人才，学徒工以及业务精英，年轻的团队，和谐的氛围，朝气蓬勃的发展，期待您的加入！</font></p>
                <p>&nbsp;</p>
                <p><span style="FONT-SIZE: 13px"><strong>业务经理<br></strong>
                	<br></span>职责描述：<span class="Apple-converted-space">&nbsp;</span>
                    <br>1.开拓视音频设备租赁市场；<span class="Apple-converted-space">&nbsp;</span>
                    <br>2.负责租赁合同的签订及回款；<span class="Apple-converted-space">&nbsp;</span>
                    <br>3.客户关系管理。<span class="Apple-converted-space">&nbsp;</span>
                    <br>
                    <br>任职条件:<span class="Apple-converted-space">&nbsp;</span>
                    <br>1.女性，年龄22－35；<span class="Apple-converted-space">&nbsp;</span>
                    <br>2.投影、大屏幕相关行业或展览(演出\广告\会议＼电视台)相关工作经历优先；<span class="Apple-converted-space">&nbsp;</span>
                    <br>3.有亲和力、较好的沟通协调能力。<span class="Apple-converted-space">&nbsp;</span>
                    <br>4.责任心强，有团队意识；<span class="Apple-converted-space">&nbsp;</span>
                    <br>5.性格开朗，坚韧，勇于承受压力。<span class="Apple-converted-space">&nbsp;</span>
                    <br>6.熟悉(演出\广告\会议＼电视台）行业优先
                </p>
