  ...
  <div id="main"> 
        ...
        <div class="rbg left">
        	<div class="right_title">&nbsp;&nbsp;&nbsp;&nbsp;租赁设备</div>
                ...
                <div style="height:30px; line-height:30px; text-align:left; padding-top:10px;"><font size="2"><strong><?php echo $name;?></strong></font></div>
                <div style=" text-align:center;"><img src="uploadfile/products/<?php echo $id;?>" width="500"></div>
                <div id="product_desc">
                	<p><font>现在LED电子显示屏在各种大型演出的舞台上得到充分的应用</font></p>
                    
                    <p><font>如果您承接各种大型晚会、庆典、会议、演出等业务， 对LED显示屏设备有需求时，&nbsp; 请联系我们， 我们提供室内、户外各种规格的全彩色显示屏（4mm、6mm、、10mm、16mm、和彩幕），尺寸大小、时间长短皆可以任意选择，可满足不同客户的需求，设备具有易安装、易拆除、可任意拼组，便于运输等特点。我们为您承诺：跟踪式的全程服务、专业技术人员调试和维护、最富市场竞争力的价格，欢迎来函来电洽谈！</font></p>
