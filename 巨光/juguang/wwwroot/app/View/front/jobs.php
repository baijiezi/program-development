...
<div id="page">
    ...
    <div id="main"> 
        <div class="index_left left">
        	...
        	<div class="left_list"  >-&nbsp;&nbsp;<a href="<?php echo \PestMVC\Helper::url('jobs')?>" title="业务经理">业务经理</a></div>
            <div class="left_list"  >-&nbsp;&nbsp;<a href="<?php echo \PestMVC\Helper::url('jobs/customer')?>" title="客服经理">客服经理</a></div>
            <div class="left_list"  >-&nbsp;&nbsp;<a href="<?php echo \PestMVC\Helper::url('jobs/ledengineer')?>" title="LED应用工程师">LED应用工程师</a></div>
        </div>
