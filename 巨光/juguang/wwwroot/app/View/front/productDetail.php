  ...
  <div id="main"> 
        ...
        <div class="rbg left">
        	<div class="right_title">&nbsp;&nbsp;&nbsp;&nbsp;租赁设备</div>
                ...
                <div style="height:30px; line-height:30px; text-align:left; padding-top:10px;"><font size="2"><strong><?php echo $product->name ?></strong></font></div>
                <div style=" text-align:center;"><img src="<?php echo PRODUCT_PIC_BASE_PATH . $product->pic ?>" width="500"></div>
                <div id="product_desc">
