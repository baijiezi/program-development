...
<div id="page">
    ...
    <div class="content_body">
        ...
        <div class="case_main">
            ...
            <div class="content">
            	<div style="text-align:center; height:30px; line-height:30px;"><strong><?php echo $news->title;?></strong></div>
            	<div style="height:30px; line-height:30px; text-align:center;">发布时间：<?php echo $news->created;?>&nbsp;&nbsp;</div>
            	<div style="line-height:22px;"><font face="宋体"><?php echo $news->content;?></font></div>
            </div>
        </div>
        <div class="clear"></div>
    </div>
