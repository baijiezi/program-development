        ...
        <div class="index_left left">
            ...
            <?php
            	foreach ($product_list as $p) {
					echo '<div class="left_list"  >-&nbsp;&nbsp;<a href="' . \PestMVC\Helper::url('products/' . $p->product_id ) . '" title="' . $p->name . '">' . $p->name . '</a></div>'; 
				} 
            ?>
        </div>
				...
				if ($products == null) {
					...
					foreach ( $products as $p ) {
						...
						<td align="left" style="padding-top:2px;">
							<div style="width:200px; margin:0 4px;">
								<div class="p_img"><a href="<?php echo \PestMVC\Helper::url('products/' . $p->product_id )?>" title="<?php echo $p->name ?>"><img src="<?php echo PRODUCT_PIC_BASE_PATH . $p->pic ?>" width="200" height="140" border="0"></a></div>
								<div class="p_font" style="text-align:center;"><a href="<?php echo \PestMVC\Helper::url('products/' . $p->product_id )?>" title="<?php echo $p->name ?>"><?php echo $p->name ?></a></div>
							</div>
						</td>
