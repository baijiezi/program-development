        ...
        <div class="case_main">
            ...
            <div class="case_content">
                <div class="case_row">
                	<?php
                		foreach ($cases as $c) {
							echo '<div class="one_case">';
                			echo '<a href="' . \PestMVC\Helper::url('cases/' . $c->case_cat_id) . '"><img src="' . CASES_PIC_BASE_PATH . $c->case_cat_pics . '" alt="" /></a>';
                			echo '<span><a href="' . \PestMVC\Helper::url('cases/' . $c->case_cat_id) . '">' . $c->case_cat_name . '</a></span>';
                			echo '</div>';
                		} 
                	?>
                </div>
            ...
            <div class="clear"></div>
            <div class="page_nav"><?php echo $pager;?></div>
        </div>
        <div class="clear"></div>
    </div>
    <div id="footer">
