...
<div class="span9">
	<div class="hero-unit">
		...
		<form id="addJobForm" name="addJobForm" method="post"
			...
			<input name="job_id" value="<?php echo $job->job_id?>"
				type="hidden" />
			<div class="control-group">
				<label class="control-label" for="name">职位名称</label>
				<div class="controls">
					<input name="name" type="text" placeholder="请输入职位名称"
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea id="description" class="ckeditor" name="description"><?php echo $job->description;?></textarea>
				</div>
			</div>
